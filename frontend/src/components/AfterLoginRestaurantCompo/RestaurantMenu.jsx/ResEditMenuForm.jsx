...
const ResEditMenuForm = ({ show, handleClose,editId }) => {
    ...
    useEffect(() => {
           ...
           if(loadData){
            axios.get(`https://cicd-production-6388.up.railway.app/api/menu/EditMenu/${editId}`,
                {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.patch(`https://cicd-production-6388.up.railway.app/api/menu/ResMenu/${editId}`, formData, {
                headers: {
