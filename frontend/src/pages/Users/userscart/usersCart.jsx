...
const UsersCart = () => {
  ...
  const createOrder = async (orderData) => {
    try {
      const response = await axios.post("https://cicd-production-6388.up.railway.app/api/order/newOrder", orderData, {
  ...
  const fetchUserAddresses = async () => {
    try {
      const response = await axios.get(`https://cicd-production-6388.up.railway.app/api/addresses/deliveryaddress/${userId}`);
  ...
  const handleDeliveryAddress = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://cicd-production-6388.up.railway.app/api/addresses/deliveryaddress", {
        address,
        country,
        state,
        city,
  ...
  const handlePayment = async () => {
    try {
      ...
      const response = await fetch("https://cicd-production-6388.up.railway.app/api/payment/checkout", {
        method: "POST",
        headers: headers,
      ...
      var options = {
        ...
        handler: async function (response) {
          ...
          const api = await fetch("https://cicd-production-6388.up.railway.app/api/payment/verify-payment", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
